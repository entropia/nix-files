        ...
        let
          ...
          shairportConfigFile = pkgs.writeText "shairport.conf" ''
            ...
            mqtt = {
            	...
            	hostname = "mqtt.club.entropia.de"; // Hostname of the MQTT Broker
            	...
            	topic = "aerosound/test/shairport"; //MQTT topic where this instance of shairport-sync should publish. If not set, the general.name value is used.
